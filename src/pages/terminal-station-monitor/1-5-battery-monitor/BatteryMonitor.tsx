    ...
    <Page showStation={true} pageId={props.pageId} className="benefit-monitor-page" style={{ padding: 10 }}>
      ...
      <FullContainer>
        ...
        <Row className="e-mt20">
          <Col>
            <DetailItem label={utils.intl('最大电压')}>
              {detail.maxVoltage}V
                <WankeUp1Outlined style={{ marginLeft: 3 }} />
            </DetailItem>
          </Col>
          <Col>
            <DetailItem label={utils.intl('最小电压')}>
              {detail.minVoltage}V
                <WankeDown1Outlined style={{ marginLeft: 3 }} />
            </DetailItem>
          </Col>
          <Col>
            <DetailItem label={utils.intl('最大温度')}>
              {detail.maxTemperature}℃
                <WankeUp1Outlined style={{ marginLeft: 3 }} />
            </DetailItem>
          </Col>
          <Col>
            <DetailItem label={utils.intl('最小温度')}>
          ...
          </Col>
          {
            props.batteryType === 'Temperature,Voltage,Resistance' && (
              <>
                <Col>
                  <DetailItem label={utils.intl('最大内阻')}>
                    {detail.maxResistance}Ω
                    <WankeUp1Outlined style={{ marginLeft: 3 }} />
                  </DetailItem>
                </Col>
                <Col>
                  <DetailItem label={utils.intl('最小内阻')}>
          ...
          <Col>
            <DetailItem label={utils.intl('最后更新时间')} labelStyle={{ width: 120 }}>
