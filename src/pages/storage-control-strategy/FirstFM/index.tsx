...
import { FIRST_FM_CHART, getChartData } from '../dataCfg'
import moment from 'moment'

const { Option } = Select

export interface FirstFMProps {
  energyUnitsList: any[]
...
export default class FirstFM extends Component<FirstFMProps> {
  filterForm: any
  ...
  searchChart = () => {
    ...
    validateFields()
      .then(values => {
        searchChart && searchChart(values, FIRST_FM_CHART)
      }).catch(errorInfo => {
        errorInfo
      })
  }
