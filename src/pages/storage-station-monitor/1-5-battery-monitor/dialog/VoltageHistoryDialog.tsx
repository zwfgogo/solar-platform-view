...
export const VoltageHistoryDialog: React.FC<Props> = function (this: null, props) {
  ...
  return (
    ...
    >
      <FullContainer>
        ...
        <section className="flex1" style={{ marginTop: 10, height: 300, flexBasis: 'auto' }}>
          <LineChart
